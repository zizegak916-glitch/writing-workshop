(function (root) {
  ...
  entries.push(
    ...
    { id: 'memory.foundation-compress', label: '项目设定与大纲分块记忆', maxTokens: 4096, minTimeoutMs: 300000 },
    { id: 'memory.foundation-merge', label: '项目设定与大纲记忆合并', maxTokens: 8192, minTimeoutMs: 300000 },
    { id: 'memory.chapter-compress', label: '长篇章节分块记忆', maxTokens: 4096, minTimeoutMs: 300000 },
    { id: 'memory.chapter-merge', label: '长篇章节记忆合并', maxTokens: 4096, minTimeoutMs: 300000 },
    { id: 'memory.arc-compress', label: '长篇阶段记忆压缩', maxTokens: 8192, minTimeoutMs: 300000 },
    { id: 'memory.book-compress', label: '长篇全书记忆压缩', maxTokens: 8192, minTimeoutMs: 300000 },
